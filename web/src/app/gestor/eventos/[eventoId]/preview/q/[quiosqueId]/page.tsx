...
// completo dessa rota.
export default async function PreviaLojaDoQuiosque({
  params,
}: {
  ...
  return (
    <main className="tela">
      <div className="conteudo-com-fundo">
        ...
        >
          👁 Prévia do gestor
          {semRecebedor && " — este quiosque ainda não tem recebedor conectado, o cliente não vê isso hoje"}
          .{" "}
          <Link href={`/gestor/eventos/${params.eventoId}/preview`} style={{ textDecoration: "underline" }}>
            ‹ Voltar pra praça
          </Link>
        </div>
