...
import type { AnalyticsQuiosque } from "@/lib/analyticsQuiosque";
...
export function PainelAnalisesQuiosque({ dados }: { dados: AnalyticsQuiosque }) {
  ...
  return (
    <>
      ...
      <div className="g-grid">
        <div className="kpi">
          <div className="n">{dinheiro(dados.vendasTotal)}</div>
          <div className="l">Vendas totais</div>
        </div>
        <div className="kpi">
      ...
      {!dados.ehBrincadeiras && (
        <div className="g-grid" style={{ marginTop: 12 }}>
          <div className="kpi">
      ...
      <div className="g-grid-graficos">
        ...
        <div className="g-sec" style={{ margin: 0 }}>
          <h5 style={{ fontFamily: "var(--font-sora)", marginBottom: 12 }}>🔄 Funil de status</h5>
          <GraficoColunas dados={dados.funil} />
        </div>
          ...
          >
            <h5 style={{ fontFamily: "var(--font-sora)", margin: 0 }}>
              ...
              {!monitorExpandido && dados.slaLinhas.length > 0 && (
                <span className="texto-fraco" style={{ fontWeight: 400, fontSize: 12.5 }}>
                  {" "}
                  · {dados.slaLinhas.length} pedido{dados.slaLinhas.length === 1 ? "" : "s"}
                </span>
              )}
            </h5>
            <span
